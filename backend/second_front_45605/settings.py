"""
Django settings for second_front_45605 project.
...
ROOT_URLCONF = 'second_front_45605.urls'
...
WSGI_APPLICATION = 'second_front_45605.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "second_front_45605 API",
    "DESCRIPTION": "API documentation for second_front_45605 App",
    "VERSION": "v1",
}
